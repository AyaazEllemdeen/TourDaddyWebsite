...
import { yachtpackages } from "../../../data/data";
        ...
        <section className="relative table w-full items-center py-36 bg-[url('../../assets/images/bg/cta.jpg')] bg-top bg-no-repeat bg-cover">
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 pb-8 text-center mt-10">
                    <h3 className="text-4xl leading-normal tracking-wider font-semibold text-white">Yacht Packages</h3>
                </div>
            </div>
                        ...
                        return(
                            <div className="group rounded-md shadow dark:shadow-gray-700" key={index}>
                                ...
                                <div className="p-4">
                                    ...
                                    <Link to={`/yacht-detail/${item.id}`} className="text-lg font-medium hover:text-red-500 duration-500 ease-in-out">{item.title}</Link>
