...
const TourGrid = () => {
  ...
  useEffect(() => {
    axios.get('https://delicate-rhythm-1a2ffffd6a.strapiapp.com/api/halfdayprivatetour')
      .then(response => {
      ...
      <section className="relative table w-full items-center py-36 bg-[url('../../assets/images/bg/cta.jpg')] bg-top bg-no-repeat bg-cover">
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            <h3 className="text-4xl leading-normal tracking-wider font-semibold text-white">HALF DAY PRIVATE TOURS</h3>
          </div>
        </div>
